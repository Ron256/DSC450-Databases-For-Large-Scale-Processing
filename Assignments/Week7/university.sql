...
/***************************************************************
* A trigger that caps the course number column at 598.
* In case an update or insert would provide course number 599 or higher
* reset automatically back at 598
******************************************************************/
CREATE OR REPLACE TRIGGER checkCourseNr
BEFORE UPDATE OR INSERT OF CourseNr ON Course
FOR EACH ROW
WHEN (new.CourseNr > 598)
BEGIN
    :new.CourseNr := 598;
    DBMS_OUTPUT.PUT_LINE('The new Course Number can not be greater than 598');
END;


--Inserting sample data
INSERT INTO Course VALUES (2988, 'Health Care Data Analysis', 'MKT', 798);
INSERT INTO Course VALUES (2989, 'Big Data And NoSQL', 'CSC', 650);
